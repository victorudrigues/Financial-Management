        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PixFeePercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    SettlementDays = table.Column<int>(type: "int", nullable: false),
                    AllowsAnticipation = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompetenceDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SettlementDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PaymentMethod = table.Column<int>(type: "int", nullable: false),
                    ExpenseNature = table.Column<int>(type: "int", nullable: true),
                    ...
                    PaymentMachineId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    ExpectedSettlementDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LinkedFeeTransactionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CompetenceDate",
                table: "Transactions",
                column: "CompetenceDate");
